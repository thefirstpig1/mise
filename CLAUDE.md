...
- Sprint 2: 🚧 IN PROGRESS — Part 10 Stock Movement (append-only ledger, ADR 0011) ✅ COMPLETE 2026-08-15 · Part 11 Purchase Order (ADR 0012) ✅ COMPLETE 2026-08-16 · Part 13 Goods Receipt (ADR 0013) ✅ COMPLETE 2026-08-16 · Part 13.5 carry-forward debt payoff (adjust `submit_key` + advisory-lock counters, closes Pitfall #25) ✅ COMPLETE 2026-08-16; next: **Part 14 Cost Engine** (Part 12 unallocated — Part 11 absorbed it; see docs/sprint-progress.md)
