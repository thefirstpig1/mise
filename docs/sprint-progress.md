...
Cost when stock is exactly zero (no layers, no debt) · what UI ships beyond the branch-comparison page · whether the cost read is exposed to Sprint 3 before Sprint 5 needs it.
